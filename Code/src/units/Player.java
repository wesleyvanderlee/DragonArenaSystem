...
public class Player extends Unit implements Runnable, Serializable
{
	 ...
	 * @throws IOException 
	 */
	public Player(String battlefieldID, int x, int y) throws IOException 
	{
		/* Initialize the hitpoints and attackpoints */
		super(battlefieldID, (int)(Math.random() * (MAX_HITPOINTS - MIN_HITPOINTS) + MIN_HITPOINTS), (int)(Math.random() * (MAX_ATTACKPOINTS - MIN_ATTACKPOINTS) + MIN_ATTACKPOINTS));
